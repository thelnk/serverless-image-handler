...
Such a precious thing. Instead of applying the patch, rebuilding from source, and going about it properly... I downloaded the transpiled lambda zip from the aws console, edited some JS files and moved on with my life 🤷. Whoever works on this next, be better than me!  
.  
.  
.  
.  
